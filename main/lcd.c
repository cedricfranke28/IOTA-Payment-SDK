...
void lcd_display_qr() {
  ...
  uint8_t tempBuffer[qr_buff_len];
    ...
    bool ok = qrcodegen_encodeText("atoi1qrshql50hse7t02da5g7w63w4fp2f7pv44zeakz4qalep3ypq3q574444a3", tempBuffer, qr0, qrcodegen_Ecc_MEDIUM, qr_version, qr_version,
